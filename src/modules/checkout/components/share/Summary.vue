            ...
            <div class="border p-5 rounded-xl">
                ...
                <div class="flex flex-col space-y-6 border-b-2 pb-6">
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <span class="text-red-500"> {{ $filters.separate(cart?.items_discount) }} تومان</span>
                    </div>

                    <div class="flex items-center justify-between" v-if="showVoucher()">
                        <span class="text-gray-600">کد تخفیف</span>
                        <span class="text-red-500"> {{ $filters.separate(cart?.voucher_discount) }} تومان</span>
                    </div>

                    <div class="flex items-center justify-between" v-if="showShipment()">
                        <span class="text-gray-600">هزینه ارسال</span>
                        <span class="">{{ $filters.separate(cart?.shipment_cost) }} تومان</span>
                    </div>
                </div>
                ...
                <div class="pt-6">
                    <div class="flex items-center justify-between">
                        ...
                        <span class="">{{ $filters.separate(cart?.payable_price) }} تومان</span>
                    </div>
                    <div class="mt-6">
