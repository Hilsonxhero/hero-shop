    ...
    >
      ...
      <section class="lg:pr-4 xl:pr-8">
        ...
        <div class="hidden lg:flex lg:flex-col lg:space-y-6">
          ...
          <span class="text-typo-light text-sm"
            >با ارسال نظر ضمن کمک به دیگران، اگر کالا را از فالکون خریده باشید
        ...
        <div class="flex items-start w-full">
          ...
          >
            ...
            <section class="lg:mx-auto lg:w-full">
              ...
              <div
                class="flex hidden items-center justify-start w-full lg:flex"
              >
                <div class="flex lg:flex-col lg:space-y-4 lg:items-center">
                  <span class="text-sm font-bold"
                    >شما هم نظرتان را بنویسید</span
                  >
                  <span class="text-center text-typo-light text-sm text-xs"
          ...
          <div
            class="block w-full overflow-hidden lg:flex-grow lg:pr-4"
            style=""
          >
            <section class="flex mb-4 lg:items-center">
              <div class="justify-between flex item-center">
                ...
                <i
                  ...
                  class="block ml-4 mr-4 text-typo-light text-4xl lg:mr-32 material-icons t-icon-sort-24px"
                ></i>
              </div>
              <span
                      ...
                      >
                        ...
                        >
                          ...
                          <div class="flex item-center">
                            <span
                              class="hidden w-1.5 h-1.5 bg-typo-lighter rounded-full lg:inline"
                            ></span>
                            <span class="ml-1 text-typo-light text-xs lg:mx-2"
                              >فروشنده</span
                            >
                            <div class="flex item-center">
                              <span class="text-typo-light text-xs">
