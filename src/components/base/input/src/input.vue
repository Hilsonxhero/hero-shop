<template>
  <div v-show="type !== 'hidden'" v-bind="containerAttrs" :class="[
    ...
    $attrs.class,
  ]" :style="containerStyle" :role="containerRole" @mouseenter="handleMouseEnter" @mouseleave="handleMouseLeave">
    <!-- input -->
      ...
      <div :class="[nsInput.e('wrapper'), nsInput.is('focus', focused)]">
        ...
        <span v-if="$slots.prefix || prefixIcon" :class="nsInput.e('prefix')">
          <span :class="nsInput.e('prefix-inner')">
            <slot name="prefix" />
            <hx-icon v-if="prefixIcon" class="" :class="nsInput.e('icon')" :icon="prefixIcon"></hx-icon>
          </span>
        </span>
        ...
        <input :id="inputId" ref="input" :class="nsInput.e('inner')" v-bind="attrs"
          ...
          :aria-label="label" :placeholder="placeholder" :style="inputStyle" @compositionstart="handleCompositionStart"
        ...
        <span v-if="suffixVisible" :class="nsInput.e('suffix')">
          <span :class="nsInput.e('suffix-inner')">
            <template v-if="!showClear || !showPwdVisible || !isWordLimitVisible">
              <slot name="suffix" />
              <hx-icon v-if="suffixIcon" class="" :class="nsInput.e('icon')" :icon="suffixIcon"></hx-icon>
            </template>
            ...
            <hx-icon @click="handlePasswordVisible" v-if="showPwdVisible"
              :class="[nsInput.e('icon'), nsInput.e('password')]" class="" :icon="passwordIcon"></hx-icon>
            ...
            <hx-icon v-if="validateState && needStatusIcon" class="" :class="[
              nsInput.e('icon'),
              nsInput.e('validateIcon'),
              nsInput.is('loading', validateState === 'validating'),
            ]" icon="validate"></hx-icon>
    ...
    <template v-else>
      <textarea :id="inputId" ref="textarea" :class="nsTextarea.e('inner')" v-bind="attrs" :tabindex="tabindex"
        ...
        :aria-label="label" :placeholder="placeholder" @compositionstart="handleCompositionStart"
        @compositionupdate="handleCompositionUpdate" @compositionend="handleCompositionEnd" @input="handleInput"
        @focus="handleFocus" @blur="handleBlur" @change="handleChange" @keydown="handleKeydown" />
...
const calcIconOffset = (place: 'prefix' | 'suffix') => {
  ...
  if (slots[pendant]) {
    target.style.transform = `translateX(${place === 'suffix' ? '-' : ''}${el.querySelector(`.${nsInput.be('group', pendant)}`).offsetWidth
      }px)`
  } else {
