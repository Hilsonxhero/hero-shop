      ...
      <section class="comments-container">
        <section class="flex lg:hidden lg:px-[3.375rem]">
          ...
          <div class="w-full mt-1 lg:mt-0">
              ...
              <form class="h-full">
                <div class="space-y-3 lg:space-y-3">
                  <hx-form-group label="پرسش خود را مطرح کنید">
                    <hx-textarea placeholder="بنویسید ..."></hx-textarea>
                  </hx-form-group>
            ...
            <div
              class="hidden"
              teleportto="end-of-body"
              bottomsheetmaxsize="md"
            >
              <div>
                <div>
                  <div
                        ...
                        >
                          <div class="t-row justify-between lg:justify-start">
                            <span class="text-xs font-medium lg:ml-4"
                              >حسین قنبرزاده افروزی</span
                            >
                            <span class="text-typo-light text-xs lg:text-sm"
                              >1401 خرداد 28</span
                            >
                          </div>
                        ...
                        >
                          ...
                          >
                            <p class="block w-full text-sm lg:font-medium">
                              دوست خوب فالکون سلام،گارانتی ها بصورت رندم ارسال
                              میشود و همه ی گارانتی های طرح قرارداد،جز معتبرترین
                              گارانتی های کشور است.
                            </p>
                            <section
