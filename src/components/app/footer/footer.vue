            ...
            <div class="bg-gray-100 overflow-hidden rounded-xl mb-8 w-full px-6 flex content-between items-center">
                <div class="flex-grow hidden lg:block">
                    <div class="flex text-sm py-5">
                        ...
                        <div class="">
                            <a class="text-gray-600 text-sm" href="tel:034-91002425"> 034-91002425</a>
                            <span class="pr-4  text-sm font-bold text-gray-600">شنبه تا چهارشنبه ۸ الی
                                ۲۱ - پنجشنبه 8 الی ۲۰:۳۰</span>
                        </div>
                    </div>
                    <div class="flex text-sm mt-2">
                        <div class="text-gray-700 ml-3">ایمیل</div>
                        <a class="text-gray-600 text-sm" href="mailto:info@gmail.com">info@gmail.com</a>
                    </div>
                </div>
                ...
                <div
                    ...
                    <div class="flex items-center justify-center flex-col">
                        <a href="/page/send-method" rel=""
                            class="items-center w-36 h-[7.75rem] t-col flex flex-col justify-center lg:w-[9.25rem] lg:h-[9.25rem]"><span
                                class="w-14 h-14 lg:w-16 lg:h-16 block"><img src="/media/icons/fastSend.svg"
                                    loading="lazy" alt="ارسال سریع"
                    ...
                    <div class="flex items-center justify-center flex-col">
                        <a href="/contact-us" rel="noopener noreferrer nofollow"
                            class="items-center w-36 h-[7.75rem] t-col flex flex-col justify-center lg:w-[9.25rem] lg:h-[9.25rem]"><span
                                class="w-14 h-14 lg:w-16 lg:h-16 block"><img src="/media/icons/phoneSupport.svg"
                                    loading="lazy" alt="پشتیبانی تلفنی"
                                    class="w-full h-full transition-opacity duration-500" width="64" height="64">
                    ...
                    <div class="flex items-center justify-center flex-col">
                        <a href="/page/guarantee" rel="noopener noreferrer nofollow"
                            class="items-center w-36 h-[7.75rem] t-col flex flex-col  justify-center lg:w-[9.25rem] lg:h-[9.25rem]"><span
                ...
                <div class="grid grid-cols-12   gap-y-8  lg:pb-6">
                    ...
                    <div class="col-span-12 lg:col-span-3 flex flex-col">
                        ...
                        <div class="my-5 lg:mb-0 lg:mt-2">
                            <div class="mb-4 text-gray-800 text-sm font-extrabold lg:mb-3 lg:text-base">
