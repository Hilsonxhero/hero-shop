<template>
    <div class="relative t-header__box">
        <div class="relative w-full t-header__search">
            ...
            <hx-icon icon="search" class="w-6 h-6 absolute top-1/2 mr-1 text-gray-400 cursor-pointer">
            </hx-icon>
        </div>
        <div v-show="visiableSearchBox" class="absolute w-full top-0 left-0 bg-white shadow-md rounded-xl">
            <div class="flex-grow">
                <div class="flex flex-col h-full">
                    <div class="p-4">
                        <div class="relative w-full">
                            <input class="text-sm w-full py-2 pr-8 border-b-2 border-blue-300" type="text"
                                placeholder="جستجو  ..">
                            <hx-icon icon="search"
                            ...
                            <div class="flex flex-col w-full my-4 max-h-96 overflow-auto">
                                <router-link to="/"
                                    ...
                                    <div class="flex items-center flex-grow">
                                        <span>
                                            <hx-icon class="h-6 w-6 text-gray-400" icon="search"></hx-icon>
                                        </span>
                                    ...
                                    <div>
                                        <hx-icon class="h-6 w-6 text-gray-400" icon="chevron-left"></hx-icon>
                                    </div>
                                </router-link>
                            </div>
                        </div>
